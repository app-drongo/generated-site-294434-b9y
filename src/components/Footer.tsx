          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-xl">DocuAI</span>
              </Link>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Unlock the power of your documents with AI-driven analysis. DocuAI is a modern SaaS platform that helps enterprise companies and law firms extract insights from PDFs, contracts, and reports using advanced AI technology.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">hello@docuai.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 DocuAI. All rights reserved.</span>
